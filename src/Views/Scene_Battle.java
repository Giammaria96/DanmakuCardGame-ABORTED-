...
public class Scene_Battle extends Battle{
    ...
    public static Scene scene() {
        ...
        MainPane.setScaleX(Main.W.doubleValue() / 5320.0D);
        MainPane.setScaleY(Main.H.doubleValue() / 3600.0D);
    ...
    private static GridPane getMainGridPane() {
        ...
        MainGrid.getColumnConstraints().addAll(new ColumnConstraints[]{col1, col2, col3, col4});
        MainGrid.getRowConstraints().addAll(new RowConstraints[]{row1, row2, row3, row4});
        return MainGrid;
    }
    ...
    private static GridPane getCentralGridPane() {
        ...
        CentralPane.getColumnConstraints().addAll(new ColumnConstraints[]{new ColumnConstraints(720.0D, 720.0D, 720.0D), new ColumnConstraints(720.0D, 720.0D, 720.0D), new ColumnConstraints(720.0D, 720.0D, 720.0D), new ColumnConstraints(720.0D, 720.0D, 720.0D), new ColumnConstraints(720.0D, 720.0D, 720.0D)});
        CentralPane.getRowConstraints().addAll(new RowConstraints[]{new RowConstraints(100.0D, 100.0D, 100.0D), new RowConstraints(815.0D, 815.0D, 815.0D), new RowConstraints(815.0D, 815.0D, 815.0D), new RowConstraints(150.0D, 150.0D, 150.0D)});
        Label[] steps = new Label[]{step1, step2, step3, step4, step5};
        Label[] var2 = steps;
        int var3 = steps.length;

        for(int var4 = 0; var4 < var3; ++var4) {
            Label step = var2[var4];
        ...
        ViewStats.setOnAction(e-> {for(Player player :
                Players) player.viewStats();});
        ...
        GridPane.setRowSpan(DeckView, Integer.valueOf(2));
        GridPane.setRowSpan(UsedCardView, Integer.valueOf(2));
        GridPane.setRowSpan(CollectedIncidentCardView, Integer.valueOf(2));
        GridPane.setRowSpan(IncidentDeckView, Integer.valueOf(2));
        GridPane.setRowSpan(usedIncidentView, Integer.valueOf(2));
