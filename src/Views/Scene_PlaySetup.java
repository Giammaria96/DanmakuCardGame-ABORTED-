    ...
    public static Scene scene(){
        ...
        Play.setOnAction(e->{
            ...
            if (NofPlayer==NofSelectedRoles){
                ...
                int i=1;
                if (cb_AntiHeroine.isSelected())        {Roles[i]=1 ;i++;}
                if (cb_Challenger.isSelected())         {Roles[i]=2 ;i++;}
                if (tb_Ex_Boss.isSelected())            {Roles[i]=3 ;i++;}
                if (cb_Ex_Mid_Boss.isSelected())        {Roles[i]=5 ;i++;}
                if (cb_Final_Boss.isSelected())         {Roles[i]=6 ;i++;}
                                                         Roles[0]=7;
                if (cb_One_True_Partner.isSelected())   {Roles[i]=8 ;i++;}
                if (cb_Partner1.isSelected())           {Roles[i]=9 ;i++;}
                if (cb_Partner2.isSelected())           {Roles[i]=10;i++;}
                if (tb_Phantom_Boss.isSelected())       {Roles[i]=11;i++;}
                if (cb_Rival.isSelected())              {Roles[i]=12;i++;}
                if (cb_Stage_Boss1.isSelected())        {Roles[i]=13;i++;}
                if (cb_Stage_Boss2.isSelected())        {Roles[i]=14;i++;}
                if (cb_Stage_Boss3.isSelected())        {Roles[i]=15;i++;}
